...
public class Odev10 {
    // isUnique adında bir method oluşturun.Parametre olarak int array alır.
    ...
    public static void main(String[] args) {
        int[] a={3, 8, 12, 2, 9, 17, 43, -8, 46, 203, 14, 97, 10, 4};
        System.out.println("isUnique(a) = " + isUnique(a));
        int[] b={4, 7, 2, 3, 9, 12, -47, -19, 308, 3, 74};
        System.out.println("isUnique(b) = " + isUnique(b));
    }
